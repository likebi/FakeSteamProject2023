...
public class Listener implements MouseListener {
	...
	private static void playExplosionSound() {
		try {
			...
			if (level == 1) {
				audioFilePath = "C:\\Users\\zijun\\IdeaProjects\\Java_ShiXun2023_FinalProject\\src\\mines\\Audio\\bomb.wav";
			} else if (level == 2) {
				audioFilePath = "C:\\Users\\zijun\\IdeaProjects\\Java_ShiXun2023_FinalProject\\src\\mines\\Audio\\bomb.mp3";
			} else if (level == 3) {
				audioFilePath = "C:\\Users\\zijun\\IdeaProjects\\Java_ShiXun2023_FinalProject\\src\\mines\\Audio\\bomb.wav";
			} else {
				// Default audio file if level is not recognized
				audioFilePath = "C:\\Users\\zijun\\IdeaProjects\\Java_ShiXun2023_FinalProject\\src\\mines\\Audio\\bomb.wav";
			}

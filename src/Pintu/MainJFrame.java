...
public class MainJFrame extends JFrame implements Runnable {
    ...
    public MainJFrame() {
        ...
        soundManager.loadSound("C:\\Users\\User\\Desktop\\pintu\\Audio\\PintuFinished.wav");
        soundManager.loadSound("C:\\Users\\User\\Desktop\\pintu\\Audio\\PinTuMove.wav");
        // 结束游戏
        ...
        itemrecord.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                try {
                    // 判断文件是否存在
                    File f = new File("C:\\游戏记录.dat");
                    if (f.exists()) {
                        // 创建指向***的文件字符输入流对象
                        FileReader fr = new FileReader("C:\\游戏记录.dat");
                        // 读取数据
    ...
    public void init() {
        ...
        // 提供左右面板的图片
        url = this.getClass().getResource("3247.jpg");
        // 创建左面板
        lp = new LeftJPanel();
        // 对标签初始化
        lp.init(url);
